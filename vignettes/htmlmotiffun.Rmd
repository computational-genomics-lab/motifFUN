---
title: 'motifFUN: A tool for searching user-defined motif along with functional annotation
  filtering criteria'
author: Praveen.bairu, Ramakrishna.K, Arijit Panda, Devadas, Abhishek Das, Sutripa Thripaty* corresponding Author
date: "`r Sys.Date()`"
output:
  html_document:
    toc: yes
